            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                        ...
                        <a href="/create-transport-car" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Ajouter un vehicule</a>
                    </div>
                </div>
                <div class="col-lg-12">
                            ...
                            <tr v-for="(stock,index) in cars" :key="index">
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        <router-link :to="'/show-transport-car/'+stock.id" 
                                        ...
                                        <router-link :to="'/edit-transport-car/'+stock.id" 
