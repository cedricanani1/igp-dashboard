                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select v-model="product.categorie_id" class="form-control" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Prix *</label>
                                            <input type="number" min="0" v-model="product.price" class="form-control" placeholder="Entrer le prix" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>     
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Stock *</label>
                                            <input type="number" min="0" v-model="product.stock" class="form-control" placeholder="Entrer le stock" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div> 
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" v-model="product.discount" class="form-control" placeholder="Entrer la reduction" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div> 
                                    <div class="col-md-6">
...
export default {
    ...
    methods:{
        store() {
            ...
            productData.append('discount',this.product.discount)
            productData.append('price',this.product.price)
            productData.append('categorie_id',this.product.categorie_id)

            axios.post(URL_LOGISTIQUE_API+'products', productData)
            .then(response => {
                console.log(response.data)
                this.product = response.data
                this.isLoading = false
                if (response.data.state) {
                    this.$router.push('/logistique-products')
                }
            })
            .catch(error => {
                console.log(error)
