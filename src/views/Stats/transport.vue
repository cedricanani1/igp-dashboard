            ...
            <div class="row">
                            ...
                            <div class="card card-block card-stretch card-height">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4 card-total-sale">
                                        ...
                                        <div>
                                            <p class="mb-2">Nombre total de locations</p>
                                            <h4> {{ this.all }} </h4>
                                        </div>
                                    </div>                                
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Meilleurs Vehicules</h4>
                            </div>
                                    ...
                                    <div class="card card-block card-stretch card-height mb-2">
                                        <div class="card-body">
                                            ...
                                            <div class="style-text text-left mt-3">
                                                ...
                                                <p class="mb-0">Montant généré : {{ best.amount }} FCFA</p>
                                                <p class="mb-0">Nombre de locations : {{ best.order_count }} </p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="col-lg-12">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Vehicules vendus</h4>
                            </div>
                                        ...
                                        <div class="card-body" >
                                            ...
                                            <div class="style-text text-left mt-3">
                                                <h5 class="mb-1"> {{ sell.libelle.toUpperCase() }} </h5>
                                                 ...
                                                 <p class="mb-0">Nombre de locations : {{ sell.count }} </p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
...
export default {
    ...
    methods: {
        ...
        getBestProduct(){
            let app = this
            axios.post(URL_TRANSPORT_API+'bestproduct', app.param)
        ...
        getSellByPeriode(){
            let app = this
            axios.post(URL_TRANSPORT_API+'getsellByPeriode', app.periode)
            .then(function (reponse){
        ...
        getBestViews(){
            let app = this
            axios.get(URL_TRANSPORT_API+'bestviews')
            .then(function (reponse){
        ...
        getSellAllTime(){
            let app = this
            axios.get(URL_TRANSPORT_API+'getsellAllTime')
            .then(function (reponse){
        ...
        getBestRate(){
            let app = this
            axios.get(URL_TRANSPORT_API+'bestrate')
            .then(function (reponse){
        ...
        getUserSeller(){
            let app = this
            axios.get(URL_TRANSPORT_API+'getuserSeller')
            .then(function (reponse) {
