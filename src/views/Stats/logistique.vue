                                    ...
                                    <div class="card card-block card-stretch card-height mb-2">
                                        <div class="card-body">
                                            <div class="bg-warning-light rounded">
                                                <img :src="url_com+best.image" class="style-img img-fluid m-auto p-3" :alt="best.photo">
                                            </div>
                            ...
                            <ul class="list-unstyled row top-product mb-0">
                                <li class="col-lg-4" v-for="(sell, index) in all_sells" :key="index">
                                    <div class="card card-block card-stretch card-height mb-2" v-if="sell.count > 0">
                                        <div class="card-body" >
                                            <div class="bg-warning-light rounded">
                                                <img :src="url_com+sell.image" class="style-img img-fluid m-auto p-3" :alt="sell.photo">
                                            </div>
                                            <div class="style-text text-left mt-3">
                            ...
                            <ul class="list-unstyled row top-product mb-0">
                                <li class="col-lg-3" v-for="(rate, index) in rates" :key="index">
                                    <div class="card card-block card-stretch card-height mb-2">
                                        <div class="card-body">
                                            <div class="bg-warning-light rounded">
                                                <img :src="url_com+rate.image" class="style-img img-fluid m-auto p-3" :alt="rate.photo">
                                            </div>
                                            <div class="style-text text-left mt-3">
                            ...
                            <ul class="list-unstyled row top-product mb-0">
                                <li class="col-lg-3" v-for="(view, index) in views" :key="index">
                                    <div class="card card-block card-stretch card-height mb-2">
                                        <div class="card-body">
                                            <div class="bg-warning-light rounded">
                                                <img :src="url_com+view.image" class="style-img img-fluid m-auto p-3" :alt="view.photo">
                                            </div>
                                            <div class="style-text text-left mt-3">
...
export default {
    ...
    methods: {
        ...
        getBestProduct(){
            let app = this
            axios.post(URL_LOGISTIQUE_API+'bestproduct', app.param)
            .then(function (reponse){
                console.log('bests', reponse.data);
        ...
        getSellByPeriode(){
            let app = this
            axios.post(URL_LOGISTIQUE_API+'getsellByPeriode', app.periode)
            .then(function (reponse){
        ...
        getBestViews(){
            let app = this
            axios.get(URL_LOGISTIQUE_API+'bestviews')
            .then(function (reponse){
        ...
        getSellAllTime(){
            let app = this
            axios.get(URL_LOGISTIQUE_API+'getsellAllTime')
            .then(function (reponse){
        ...
        getBestRate(){
            let app = this
            axios.get(URL_LOGISTIQUE_API+'bestrate')
            .then(function (reponse){
        ...
        getUserSeller(){
            let app = this
            axios.get(URL_LOGISTIQUE_API+'getuserSeller')
            .then(function (reponse) {
