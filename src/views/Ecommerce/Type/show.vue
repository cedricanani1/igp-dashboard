                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Détails de categorie</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="page-list-category.html" @submit.prevent="update" data-toggle="validator">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Slug *</label>
                                            <input type="text" v-model="product.slug" class="form-control" placeholder="Entrer libelle" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <button v-if="perms.includes('edit-product-type')" type="submit" class="btn btn-primary mr-2">Modifier</button>
                                <button v-if="perms.includes('edit-product-type')" type="reset" class="btn btn-danger">Reinitialiser</button>
                            </form>
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        ...
        getProductType() {
            this.isLoading = true
            axios.get(URL_COMMERCE_API+'product-types/'+this.$route.params.id)
            .then(response => {
        ...
        update(){
            this.$router.push('/edit-e-commerce-product-type/'+this.$route.params.id)
        }
    }
}
</script>