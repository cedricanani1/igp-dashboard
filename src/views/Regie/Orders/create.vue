                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="row col-lg-12">
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="" id="" autocomplete="name" v-model="product" class="form-control" @change="onChanges">
                                                    <option v-for="(panel, index) in panels" :key="index" :value="panel.libelle+' * '+panel.description+' * '+panel.id+' * '+panel.photo+'  * '+panel.price+' * '+panel.city.libelle"> {{ panel.libelle }} </option>
                                                </select>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                    ...
                                    <div class="col-md-6" v-if="info.libelle != ''">
                                            <div class="form-group">
                                                <img class="img" :src="URL_REGIE+info.photo" alt="">
                                            </div>
                                    </div> 
...
import {URL_REGIE_API, URL_AUTH_API, URL_REGIE} from '@/config'
// Import component
        ...
        add(){
            ...
            if (this.db != '' && this.fn != '') {
                if (this.fullname != '') {
                    ...
                    localStorage.setItem('cart_reg', JSON.stringify(this.order.cart))
        ...
        updateOrder() {
            ...
            this.order.cart = this.order.cart || []
                    ...
                    if (this.fullname != '') {
                        ...
                        this.isLoading = true
                        axios.post(URL_REGIE_API+'orders', this.order)
                        .then(response => {
