                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Créer utilisateur</h4>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" v-model="user.password_confirmation" class="form-control" placeholder="">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div> 
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Rôle *</label>
                                                <select name="" id="" class="form-control" v-model="user.role" multiple>
    ...
    methods:{
        store() {
            ...
            if(this.user.password_confirmation == this.user.password){
                    axios.post(URL_AUTH_API+'signupByAdmin', this.user)
                .then(response => {
                ...
                Swal.fire(
                            'Echec d\'operation!',
                            'Le mot de passe et sa confirmation diffèrent.',
                            'error'
                        )
            }
        },
